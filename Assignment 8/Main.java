...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        manager.addProduct(new NewProduct("Diet Coke"));
        manager.addProduct(new NewProduct("Pringles"));
        manager.addProduct(new NewProduct("Ragi Chips"));

        //Legacy Items
        LegacyItem item1 = new LegacyItem(103, "Frooti");
        LegacyItem item2 = new LegacyItem(107, "Potato Chips");
